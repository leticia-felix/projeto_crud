                ...
                <div class="max-w-xl">
                    ...
                    <form action="/recipes" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" class="text-snow font-bold text-xl bg-softgreen mt-1 block w-full"  />

                        </div>
                        <div>
                            <x-input-label for="time" value="Tempo de Preparo" class="text-green font-bold text-xl mt-2" />
                            <x-text-input id="time" name="time" class="text-snow text-xl font-bold bg-softgreen mt-1 block w-full"  />

                        </div>
                        <div>
                            <x-input-label for="instructions" value="Instruções" class="text-green font-bold text-xl mt-2"/>
                            <textarea id="instructions" name="instructions"  rows="4" class="rounded-md border-none focus-ring-none focus:outline-none p-2.5 text-snow text-xl font-bold bg-softgreen mt-1 block w-full"  ></textarea>
