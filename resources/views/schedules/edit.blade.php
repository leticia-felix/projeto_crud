                ...
                <div class="max-w-xl">
                    ...
                    <form action="{{ route('schedules.update', $schedule) }}" method="POST">
                        ...
                        <div>
                            ...
                            <select multiple id="recipe_id" name="recipe_id" class="bg-softgreen border border-none text-snow text-sm rounded-lg focus:ring-green focus:border-none block w-full p-2.5 dark:bg-noner dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green dark:focus:border-blue-500">
                                @foreach ($recipes as $recipe)
                                    <option class="text-lg text-snow font-bold" value="{{ $recipe->id }}" {{ $schedule->recipe_id == $recipe->id ? 'selected' : '' }}>
                                        {{ $recipe->title }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" id="scheduled_date" name="scheduled_date"  rows="4" class="rounded-md border-none focus-ring-none focus:outline-none p-2.5 text-snow text-xl font-bold bg-softgreen mt-1 block w-full"  value="{{ $schedule->scheduled_date }}"></input>
                        ...
                        <div>
                            ...
                            <textarea id="shopping_list" name="shopping_list" rows="4" class="rounded-md border-none focus-ring-none focus:outline-none p-2.5 text-snow text-xl font-bold bg-softgreen mt-1 block w-full">
                        ...
                        <x-primary-button type="submit" class="mt-4"> Atualizar Agenda</x-primary-button>
                    </form>
